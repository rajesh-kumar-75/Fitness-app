...
// Pre-save middleware to synchronize image, imageUrl, and thumbnailUrl
exerciseSchema.pre('save', function (next) {
  ...
  if (!this.thumbnailUrl && (this.imageUrl || this.image)) {
    this.thumbnailUrl = this.imageUrl || this.image;
  }

  if (!this.altText && this.name) {
    this.altText = `${this.name} exercise demonstration`;
  }
